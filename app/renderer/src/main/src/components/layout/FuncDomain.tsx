        ...
        >
            <div className={styles["update-header-wrapper"]}>
                <div className={styles["header-info"]}>
                    ...
                    <div>
                        <div
                            className={styles["update-title"]}
                        >{`社区版 ${getReleaseEditionName()} ${lastVersion || version}`}</div>
...
const UIOpUpdateYaklang: React.FC<UIOpUpdateProps> = React.memo((props) => {
    ...
    const isKillEngine =
        localVersion && removePrefixV(localVersion) !== removePrefixV(version) && !lowerYaklangLastVersion
